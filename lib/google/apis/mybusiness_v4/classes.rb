  ...
  module Apis
    module MybusinessV4
      ...
      class Category
        ...
        # The human-readable name of the category. This is set when reading the
        # location. When modifying the location, `category_id` must be set.
        # @OutputOnly
        # Corresponds to the JSON property `displayName`
        # @return [String]
        attr_accessor :display_name
      ...
      # Response message for ListMediaItems
      ...
      class Location
        ...
        # Don't add unnecessary information to your name (for example, prefer "Google"
        # over
        # "Google Inc. - Mountain View Corporate Headquarters").
        # Don't include marketing taglines, store codes, special characters, hours or
      ...
      class LocationKey
        ...
        # The `request_id` used to create this location. May be empty if this location
        # was created outside of the GMB API or Google My Business Locations.
        # @OutputOnly
      ...
      class LocationState
        ...
        # For more information, see [metadata.duplicate](/my-business/reference/rest/v4/
        # accounts.locations#Duplicate).
        # @OutputOnly
        ...
        # Indicates whether [accounts.locations.localPosts](/my-business/reference/rest/
        # v4/accounts.locations.localPosts) is disabled for this location.
        # @OutputOnly
      ...
      class MediaItem
        ...
        # Output only. Google-hosted URL for this photo. This URL is not static and
      ...
      class Notifications
        ...
        # The notifications resource name.
        # @OutputOnly
        # Corresponds to the JSON property `name`
        # @return [String]
        attr_accessor :name
      ...
      # Request message for StartUploadMediaItemData
